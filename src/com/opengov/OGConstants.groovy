...
class OGConstants {
  ...
  static final String AGENT_CONTAINER_CPU_MAX = '500m'
  static final String AGENT_CONTAINER_MEMORY_MAX = '1.5G'
  ...
  static final String DOCKER_CONTAINER_CPU_MAX = '500m'
  static final String DOCKER_CONTAINER_MEMORY_MAX = '2.5G'
